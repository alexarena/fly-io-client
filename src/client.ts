...
import {
  Platform,
  PlatformListRegionsParams,
  PlatformListRegionsResponse,
  PlatformPlacePlacementsParams,
  PlatformPlacePlacementsResponse,
} from './resources/platform';
import {
  TokenRequestKmsResponse,
  TokenRequestOidcParams,
  TokenRequestOidcResponse,
  TokenRetrieveCurrentResponse,
  Tokens,
} from './resources/tokens';
import {
  AppCreateDeployTokenParams,
...
export interface ClientOptions {
  /**
   * Defaults to process.env['ARENA_FLY_IO_API_KEY'].
   */
...
export class ArenaFlyIo {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.machines.dev/v1`,
    };
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.machines.dev/v1';
  }
