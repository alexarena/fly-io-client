...
```sh
npm install git+ssh://git@github.com:stainless-sdks/arena-fly-io-typescript.git
```
...
const apps = await client.apps.list({ org_slug: 'REPLACE_ME' });
...
await client.apps.list({ org_slug: 'REPLACE_ME' }, {
  maxRetries: 5,
});
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/arena-fly-io-typescript/issues) with questions, bugs, or suggestions.
